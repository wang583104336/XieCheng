...
public class FDFSUtil {
    ...
    public String uploadFile(String fileName)  throws Exception{
        String fn= upload_file(fileName, null, null);
        String host=trackerServer.getSocket().getInetAddress().getHostName();
        return "http://"+host+"/"+fn;
    }
    ...
    //删除
    public void fileList(String filename) throws IOException, MyException {
